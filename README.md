...
The instructions from https://github.com/stablecoin-labs/core and https://github.com/stablecoin-labs/gyro-sdk
need to be followed first.
Then, `gyro-sdk` needs to be linked with the following command:
